...
|   4 | [IIT(BHU)](https://www.iitbhu.ac.in/)                                                 | The 22 August homepage exposes three future 2026–27 programmes with exact ranges, department/venue text, brochure/detail links and images. The `/events` archive lags the homepage, and `.ac.in` Bright Data access plus public-audience status still require proof.                                                                                                                                                                      | Next collector spike  |
...
|  21 | [Mahindra Kabira Festival](https://mahindrakabira.com/)                               | Official organiser page names 4–6 December 2026 in Varanasi and a multi-format cultural programme. Treat the festival as one seasonal occurrence until its own schedule publishes exact session dates, venues and actions.                                                                                                                                                                                                                | Seasonal candidate    |
|  22 | [Gangotri Seva Samiti Ganga Aarti](https://www.gangotrisevasamiti.org/faq)            | Official organiser states public/free, 6:00 PM at Dashashwamedh Ghat, lasting 45–60 minutes. This is a daily recurring experience, not a newly announced one-off row.                                                                                                                                                                                                                                                                     | Later recurring lane  |
|  23 | [Subah-e-Banaras daily programme](https://subahebanaras.net/about/)                   | Official page states daily at dawn at Asi Ghat with distinct summer and winter time windows. Named-performer posts are often retrospective, so recurrence and future-performer facts must stay separate.                                                                                                                                                                                                                                  | Later recurring lane  |
|  24 | [BookMyShow Varanasi](https://in.bookmyshow.com/explore/events-varanasi)              | Useful discovery for ticketed comedy, open mics, workshops and performances, particularly on exact Varanasi venue pages. The broad page also surfaces generic/multi-city inventory and is not sufficient city evidence by itself.                                                                                                                                                                                                         | Discovery only        |
|  25 | [International Music Centre Ashram](https://inmca.org/)                               | Credible local classical-music venue, but the current surface mixes historical 2024–25 inventory with undated day/month cards. Require explicit future year and detail before qualification.                                                                                                                                                                                                                                              | Hold: freshness       |
|  26 | [Jnana-Pravaha cultural roster](https://www.jnanapravaha.org/roster-at-jnana-pravaha) | Strong first-party calendar shape, but the visible academic roster ends in March 2026 and the venue announces an April–October renovation closure.                                                                                                                                                                                                                                                                                        | Seasonal hold         |
...
Qualification recheck: 20 August 2026. The horizon is 20 August through 18
November 2026. Counts below are reproducible first-party records, not claims
that a city has no other events. Delhi and Mumbai each have one source activated
end to end; every other row remains research until it clears the same Studio,
immutable backend, API, and browser gates. Search, BookMyShow, AllEvents and
social pages are discovery leads only. Request estimates count source documents
or API calls, not embedded page assets.

### Delhi

Delhi is enabled with The Piano Man as its first active source. Government
websites remain outside the current collection policy while account access and
reuse terms are unresolved, so JNU, National Science Centre, Punjabi Academy,
IGNCA, and the other public authorities below are product-later research only.
India Habitat Centre is the next reviewed candidate, but remains local-only.
...
gates. Prithvi Theatre and The Piano Man have now cleared the complete
Studio-to-publication pipeline and both cities are enabled. NCPA and India
International Centre require written permission before either can enter that
pipeline.
